...
const PostBigItem = ({title, excerpt, date, author, img}) => {
    return (
        <div className=" hover:bg-white/[0.08] flex flex-col md:flex-row mx-5 mt-5 duration-500 transition w-[95%] md:w-auto rounded-xl">

            <div className="m-2 flex flex-row justify-center items-center aspect-w-5 aspect-h-1 md:aspect-none">
